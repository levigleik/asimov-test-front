  ...
  return (
    <section id="cta" className="page-shell mt-20 lg:mt-25 lg:pb-8">
      <div className="relative gap-6.5 overflow-hidden rounded-4xl bg-secondary px-8 py-10 lg:min-h-86.75 lg:overflow-visible lg:rounded-[45px] lg:p-15">
        <Reveal className="relative z-10 max-w-125">
        ...
        <Reveal
          delay={0.08}
          className="pointer-events-none flex justify-end lg:absolute lg:top-1/2 lg:right-15 lg:z-0 lg:mt-0 lg:-translate-y-1/2"
        >
          <Image
            src={ctaIllustration}
            alt=""

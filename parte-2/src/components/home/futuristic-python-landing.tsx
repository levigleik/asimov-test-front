	...
	return (
		...
		>
			<FollowMouseTooltip position={tooltipPosition}>
				Clique no botão direito do mouse ou bolinha vermelha para voltar
			</FollowMouseTooltip>
			<PanelFloat
				...
				<motion.div className="mx-auto grid min-h-[calc(100vh-8rem)] max-w-[1180px] items-center gap-10 lg:grid-cols-[1fr_0.92fr]">
					<div className="relative z-10">
						...
						<motion.h1
							...
							className="max-w-4xl text-balance text-5xl font-semibold leading-[0.96] text-white md:text-7xl lg:text-[58px]"
						>
						...
						<motion.ul
							...
							className="mt-9 flex max-w-2xl flex-col gap-3"
						>
							{heroBulletPoints.map((item) => (
								<motion.li
									...
									className="border-neon bg-panel flex items-center gap-3 rounded-lg px-4 py-3 text-left text-base leading-7 text-white/82"
								>
									<span className="inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-primary/14 text-sm text-primary">
										✓
									</span>
									<span>{item}</span>
								</motion.li>
